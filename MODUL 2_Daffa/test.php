...
// silakan taruh code kalian di bawah
// **********************  3  ************************** 
if ($MK_KU1102 == 'B' || $MK_KU1102 == 'A' || $MK_KU1102 == 'AB' || $MK_KU1202 == 'A' || $MK_KU1202 == 'AB') {
    $hasil = "Peminatan Kima Pangan";
} elseif ($MK_KI1201 == 'A') {
    $hasil = "Kimia Umum";
} else {
    $hasil = "Kimia Pangan";
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <h3>Masukkan nilai mata kuliah anda pada form dibawah ini</h3>
                    ...
                    //  **********************  4  **************************     
                    if (!empty($hasil)) {
                        echo "<div class='alert alert-success'>MK Anda: $hasil</div>";}
                    //  **********************  4  **************************     
